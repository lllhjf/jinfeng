...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '50b2f38c024b47479ef80c2272f97446,en:50b2f38c024b47479ef80c2272f97446',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JF Huang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Researcher 🔬', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://minei.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Bolg', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/lllhjf', // 你的twitter个人主页
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,email,facebook,twitter,line,linkedin', // 分享的服務，按顺序显示,逗号隔开
