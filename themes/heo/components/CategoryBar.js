...
export default function CategoryBar(props) {
  ...
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-[#845ec2]-600 dark:hover:border-[#845ec2]-600 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
      <div
...
const MenuItem = ({ href, name }) => {
  ...
  return (
    <div
      className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-white hover:bg-[#845ec2]-600 dark:hover:bg-[#845ec2]-600 ${selected ? 'text-white bg-[#845ec2]-600 dark:bg-[#845ec2]-600' : ''}`}>
