...
export default function CategoryBar(props) {
  ...
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-[#845ec2] dark:hover:border-[#845ec2] ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
      <div
      ...
      <div id='category-bar-next' className='flex items-center justify-center'>
        <div
          id='right'
          className='cursor-pointer mx-2 dark:text-gray-300 dark:hover:text-[#845ec2] hover:text-[#845ec2]'
        ...
        <Link
          href='/category'
          className='whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-[#845ec2] dark:hover:text-[#845ec2]'>
...
const MenuItem = ({ href, name }) => {
  ...
  return (
    <div
      className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-white hover:bg-[#845ec2] dark:hover:bg-[#845ec2] ${selected ? 'text-white bg-[#845ec2] dark:bg-[#845ec2]' : ''}`}>
