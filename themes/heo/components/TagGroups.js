              ...
              return (
                    ...
                    >
                        <div className={`${className || ''} 
                            ${selected ? 'text-white bg-[#845ec2] dark:bg-[#845ec2]' : ''}  
                            flex items-center hover:bg-[#845ec2] dark:hover:bg-[#845ec2] hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all`}
                        >
