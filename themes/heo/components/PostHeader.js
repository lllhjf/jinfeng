            ...
            {post.category && (
              <>
                <Link
                  ...
                  passHref
                  legacyBehavior>
                  <div className='cursor-pointer font-sm font-bold px-3 py-1 rounded-lg  hover:bg-white text-white bg-[#9b89b3] dark:bg-[#9b89b3] hover:bg-[#9b89b3]-500 duration-200 '>
                    {post.category}
                  </div>
                </Link>
              </>
